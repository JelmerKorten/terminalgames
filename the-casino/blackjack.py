#blackjack game goes here

# %% To Do List
# Fix betting
# Fix the looks of print statements
#
...
def blackjack(username, user_chips):
    ...
    def setup_game(card_stack, username, number_of_players = 1):
        ...
        for player in players:
            ...
            #update weights every round to keel odds correct with real life
    ...
    def main(username, user_chips):
        ...
        while True:
            ...
            if place_bet == "Main Menu":
                ...
                place_bet = eg.integerbox(msg= "How much do you want to bet?", title= "Bets", default= 10, lowerbound= 1, upperbound= user_chips)
